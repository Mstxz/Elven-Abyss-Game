...
class Gui:
    """Gui and Screen"""
    def __init__(self):
        self.WORLD_WIDTH, self.WORLD_HEIGHT = 1920 * 10, 1080 * 10
        ...
        self.background = main.game.transform.scale(background, (self.WORLD_WIDTH, self.WORLD_HEIGHT))
    ...
    def draw(self, player, camera):
        ...
        self.screen.blit(self.background, (camera.camera.x, camera.camera.y))
        self.screen.blit(player.player_img, camera.apply(player))
